...
from models.flash_ipa import utils
from einops import rearrange
from typing import Optional
from dataclasses import dataclass
from models.flash_ipa.factorizer import LinearFactorizer
...
class EdgeEmbedder(nn.Module):
    ...
    def forward(self, node_embed, translations, trans_sc, node_mask, edge_embed=None, edge_mask=None, diffuse_mask=None):
        """
        node_embed: [B,L,D]
        translations: [B,L,3]
        trans_sc: [B,L,3]
        ...
        if self.mode == "orig_no_bias" or self.mode == "flash_no_bias":
            ...
            if edge_embed is None:
                ...
                edge_embed = self.fwd_2d(node_embed, translations, trans_sc, edge_mask, diffuse_mask)  # 2d mode
    ...
    def fwd_2d(self, s, t, sc_t, p_mask, diffuse_mask=None):
        """
        s: [B,L,D]
        t: [B,L,3]
        sc_t: [B,L,3]
